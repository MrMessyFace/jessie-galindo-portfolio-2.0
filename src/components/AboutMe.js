function AboutMe() {
  return (
    <div>
      ...
      <div className="about">
        <p>
          I live in Iowa but spent most of my life in California and Nebraska. I
          am a web developer, graphic designer, podcaster, creative writer, and
          former YouTuber.
        </p>
      </div>
      <h2 id="About-Me" className="about-h2">
        About Me
      </h2>
      <br></br>
      <h2 id="Contact" className="contact-h2">
        Contact
      </h2>
      <div className="contact">
        <p>
          <i className="fa-solid fa-phone"></i> (619) 755-2515
        </p>
        <br></br>
        <p>
          <a href="emailto:jgalindo1428@yahoo.com">
